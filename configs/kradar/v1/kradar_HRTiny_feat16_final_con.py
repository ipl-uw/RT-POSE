...
model = dict(
    ...
    backbone=dict(
        type="HRNet3D",
        backbone_cfg='hr_tiny_feat16_small',
        final_conv_in = 16,
        final_conv_out = 8,
        final_fuse = 'conat',
        ds_factor=1
...
test_cfg = dict(
    post_center_limit_range=[0., -6.4, -2, 72.0, 6.4, 6], # [x_min, -y, -z, x_max, y, z] RoI
    max_per_img=30,
    nms=dict(
        use_rotate_nms=True,
...
# dataset settings
dataset_type = "KRadarDataset_OLD"
...
DATASET = dict(
  ...
  LABEL= dict(
    ...
    ROI_TYPE='roi1', # in ['default', 'cube', 'sparse_cube', 'lpc']
  ...
  RDR_CUBE = dict(
      ...
      'x': [0., 70.],     # Dim: [m] / [0.0, 71.6] for Driving corridor, arr_cube: (20, 32, 180)
      },
      GRID_SIZE=0.4, # [m],
  ...
  ROI = dict(
    roi1 = {'z': [-2., 7.21], 'y': [-6.4, 6.3], 'x': [0., 70.01]}
  ),
  CLASS_INFO=dict(
    ...
    LIST_BAD = ['27', '28', '29', '35', '36', '37', '47', '53', '57', '58'] # seq not used in training
  )
