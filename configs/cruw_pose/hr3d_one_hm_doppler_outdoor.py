...
DATASET = dict(
  DIR=dict(
    ROOT_DIR='/mnt/nas_cruw_pose_2',
    META_FILE='file_meta_outdoor.txt',
  ...
  DZYX = dict(
    ...
    # tensor zyx of shape 16, 64, 160
    GRID_SIZE=[0.0453125, 0.15703125, 0.3625], # [m], # [x, y, z]
    NORMALIZING_VALUE=(0., 1.5), # previously (0., 10.)
